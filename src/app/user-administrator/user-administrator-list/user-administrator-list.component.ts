...
@Component({
  selector: 'app-user-administrator-list',
  templateUrl: './user-administrator-list.component.html'
})
export class UserAdministratorListComponent implements OnInit, OnDestroy {
  loading: boolean;
  error: boolean;
  ...
  constructor(private userService: UserAdministratorService,
